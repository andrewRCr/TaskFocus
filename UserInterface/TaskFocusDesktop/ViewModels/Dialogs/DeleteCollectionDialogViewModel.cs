...
namespace TaskFocusDesktop.ViewModels.Dialogs
{
    public class DeleteCollectionDialogViewModel : DialogViewModelBase
    {
        ...
        public DeleteCollectionDialogViewModel(IEventAggregator events, IWindowManager window, IDataState dataState,
                                               IDataService dataService, IDataHelper dataHelper, bool isProjectCollection,
                                               int focusedCollectionId, string focusedCollectionName) : base(events, window, dataState, dataService, dataHelper)
        {
